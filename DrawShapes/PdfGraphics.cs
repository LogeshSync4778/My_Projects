...
namespace DrawShapes
{
    public class PdfGraphics
    {
        ...
        public void DrawEllipse(PdfPen pen, EllipseF ellipse)
        {
            content.Add($"{color(pen.color.ToString())} {ColType(pen.Draw.ToString())}\n{pen.Width} w {ellipse.X.X} {ellipse.X.Y} m {ellipse.A.X} {ellipse.A.Y} {ellipse.B.X} {ellipse.B.Y} {ellipse.Y.X} {ellipse.Y.Y} c {ellipse.C.X} {ellipse.C.Y} {ellipse.D.X} {ellipse.D.Y} {ellipse.X.X} {ellipse.X.Y} c {pen.Draw}");
        }
